...
function Jsquiz() {
  ...
  const questions = [
    ...
    { question: '// Write a function to generate the Fibonacci sequence up to a given number.', difficulty: 'easy' },
    ...
    { question: '// Write a function to sum all numbers in an array.', difficulty: 'easy' },
    // Medium Questions
    { question: '// Write a function to sort an array using quicksort.', difficulty: 'medium' },
    { question: '// Write a function to check if a string is a palindrome.', difficulty: 'medium' },
    { question: '// Write a function to find the first non-repeating character in a string.', difficulty: 'medium' },
    { question: '// Write a function to merge two sorted arrays into one sorted array.', difficulty: 'medium' },
    { question: '// Write a function to implement a simple calculator (add, subtract, multiply, divide).', difficulty: 'medium' },
    { question: '// Write a function to determine if two strings are anagrams of each other.', difficulty: 'medium' },
    ...
    { question: '// Write a function to validate a Sudoku board.', difficulty: 'medium' },
    // Hard Questions
    ...
    { question: '// Write a function to implement Dijkstra’s algorithm for finding the shortest path in a graph.', difficulty: 'hard' },
