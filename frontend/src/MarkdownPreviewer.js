...
import { FiCopy } from "react-icons/fi"; // React Icon for Copy
import { FiCheckCircle } from "react-icons/fi"; // React Icon for Check Circle
...
const MarkdownPreviewer = ({ markdown }) => {
  ...
  return (
    <div>
      <div className="w-full p-8 bg-slate-800 border border-gray-300 rounded-lg overflow-auto markdown-preview">
